...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Padé Spectrum Decomposition}
\label{sec:coth.pade}
%
% * idea; rational functions, numerical superiority, defintion...
% * Basic idea: polynomials bad for functions since no singularities allowed
% * simplest functions with singularities: rational functoins; their poles shall cover the poles of f
